...
| `10b4890902e2ddfeed97af100485825ba5038285` / [36250808417](https://github.com/chameleonjp-lab/sekibanmawashi/actions/runs/36250808417) | smoke 4成功、診断1成功・3失敗 | Q03の増分13は全てPlaywrightのInjectedScript由来（windowの監視1件とmouse/touch/pointer関連12件）で、アプリ側の11件は不変。WebKitの時間欄は本文86pxに対して約106pxの値が2行に分割されており、画像でも実際の折返しを確認 |
